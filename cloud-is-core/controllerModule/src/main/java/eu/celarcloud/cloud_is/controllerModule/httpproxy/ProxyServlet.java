...
public class ProxyServlet extends HttpServlet {
  ...
  /** The Constant ATTR_TARGET_URI. */
  protected static final String ATTR_TARGET_URI =
          ProxyServlet.class.getSimpleName() + ".targetUri";
  
  /** The Constant ATTR_TARGET_HOST. */
  ...
  /**
	 * Do response redirect or not modified logic.
	 *
	 * @param servletRequest
	 *            the servlet request
  ...
  /**
	 * Sets the x forwarded for header.
	 *
	 * @param servletRequest
	 *            the servlet request
	 * @param proxyRequest
  ...
  /**
	 * Rewrite query string from request.
	 *
	 * @param servletRequest
	 *            the servlet request
	 * @param queryString
